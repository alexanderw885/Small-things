# Not-Generic Readme Section
for my corne keyboard, so I can access the files at my laptop and desktop
user alexanderw885, included the entire folder to ensure rules file is saved as well
